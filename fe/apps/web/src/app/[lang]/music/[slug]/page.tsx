...
export default function MusicDetailPage() {
  ...
  useEffect(() => {
    ...
    const loadDetail = async () => {
      ...
      try {
        ...
        const normalized = normalizeMusicItem(unwrapData<MusicApiItem>(detailRes.data) as MusicApiItem);
        setTrack(normalized);
  ...
  const resolvePlaylistQueue = useCallback(async (item: MusicTrack) => {
    ...
    try {
      ...
      const normalized = normalizeMusicItem(unwrapData<MusicApiItem>(response.data) as MusicApiItem);
