...
import { ChapterForm, type ChapterSubmitPayload } from "./ChapterForm";
...
interface ChapterEditorProps {
  /** UUID chương, hoặc "new" để tạo mới. */
  chapterId?: string;
  /** Ngôn ngữ hiện tại (vi/en). */
  lang: string;
  /** Điều hướng khi Back / Cancel / sau khi lưu xong. */
  backHref: string;
}

/**
 * Trình soạn/sửa chương (dùng chung). Được bọc bởi 2 route:
 *  - /[lang]/chapters/[id]            → backHref = /[lang]/chapters
 *  - /[lang]/stories/[id]/chapters/[chapterId]/edit → backHref = /[lang]/stories/[id]
 */
export function ChapterEditor({ chapterId, lang, backHref }: ChapterEditorProps) {
            ...
            initialData={
              isCreateMode
                ...
                : {
                    ...
                    language: chapter?.language ?? lang,
