  ...
  useEffect(() => {
    ...
    const fetchDetail = async () => {
      try {
        ...
        // /stories/:slug is wrapped ({ data: {...story} }); unwrap to the real object
        // so story.chapters / story.title etc. are defined.
        ...
        try {
          ...
          setRecommendedStories(unwrapList(recommendedRes.data));
        } catch (e) {
        ...
        try {
          ...
          setNewStories(unwrapList(newRes.data));
        } catch (e) {
          setNewStories([]);
        }
      } catch (error) {
