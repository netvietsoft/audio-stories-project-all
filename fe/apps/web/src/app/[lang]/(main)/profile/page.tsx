    ...
    useEffect(() => {
        ...
        const fetchRealProfileData = async () => {
            ...
            try {
                ...
                const historyList = unwrapList<HistoryItem>(historyRes.data);
                const favoriteList = unwrapList(favoriteRes.data);

                setHistoryItems(historyList);
                setFavoriteTotal(favoriteRes.data.meta?.total ?? favoriteList.length);
                setListenedTotal(historyRes.data.meta?.total ?? historyList.length);
            } finally {
