    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      <div>
        <div className="mb-2 flex items-center gap-3">
          <Link href="/ads" className="rounded-xl border border-slate-200 bg-white p-2 text-slate-500 transition hover:bg-slate-50 hover:text-orange-600">
      ...
      <AdForm initialData={initialData} isLoading={isSubmitting} showUnlockAdvanced={false} onSubmit={handleSubmit} onCancel={() => router.push('/ads')} />
    </div>
  );
}
