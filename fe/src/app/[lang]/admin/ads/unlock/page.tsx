    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link href="/admin/ads/unlock/new" className="rounded-md bg-amber-500 px-3 py-2 text-white">{t("addAd")}</Link>
          <Link href="/admin/ads" className="rounded-md border px-3 py-2">{t("manageInline")}</Link>
        </div>
      </div>
                  ...
                  <tr key={ad.id} className="hover:bg-slate-50/60">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-2">
                        <Link href={`/admin/ads/unlock/${ad.id}`} className="inline-flex items-center gap-1 rounded-lg border border-slate-200 px-3 py-2 text-xs font-bold text-slate-700 transition hover:bg-slate-100">
