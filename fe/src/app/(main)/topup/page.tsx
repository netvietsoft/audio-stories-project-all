                        ...
                        <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-xl rounded-[2rem] p-2 sm:p-4 shadow-xl shadow-slate-200/50 dark:shadow-none border border-white dark:border-slate-700/50 mb-6 sm:mb-8">
                            {packages.length > 0 ? (
                                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-5">
                                            ...
                                            >
                                                ...
                                                <div className="space-y-3 mb-6 mt-auto">
                                                    <div className="flex items-center gap-2.5 text-sm text-slate-600 dark:text-slate-300">
                                                        ...
                                                        <span className="font-medium">Không giới hạn trọn đời</span>
                                                    </div>
                                                    <div className="flex items-center gap-2.5 text-sm text-slate-600 dark:text-slate-300">
                                                        <div className="w-5 h-5 rounded-full bg-emerald-100 dark:bg-emerald-500/20 flex items-center justify-center flex-shrink-0">
                                                            <Check className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
                                                        </div>
                                                        <span className="font-medium">Nghe full mọi truyện VIP</span>
                                                    </div>
                                                </div>
                                    ...
                                    >
                                        <div className="flex items-center gap-3 mb-5 sm:mb-6 mt-2">
                                            ...
                                            <h3 className={`text-xl font-black tracking-tight ${selectedPackage?.code === 'CUSTOM' ? 'text-violet-600 dark:text-violet-400' : 'text-slate-900 dark:text-white'}`}>
                                                Tuỳ chọn số dư
                                            </h3>
                                        </div>
                                        ...
                                        {selectedPackage?.code === 'CUSTOM' ? (
                                            <div className="mb-6 relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full text-center text-3xl font-black font-sans border-2 rounded-2xl pl-10 pr-4 py-4 transition-all text-violet-700 dark:text-violet-400 bg-violet-50/50 dark:bg-violet-900/20 border-violet-200 dark:border-violet-700 focus:outline-none focus:border-violet-500 dark:focus:border-violet-500 focus:ring-4 focus:ring-violet-500/20 placeholder:text-violet-200 dark:placeholder:text-violet-800"
                                                    placeholder="10000"
                                                    autoFocus
                                                />
                                            </div>
                                            ...
                                            <div className="mb-6 flex justify-center items-center bg-slate-50 dark:bg-slate-800/50 p-5 rounded-2xl border border-slate-100 dark:border-slate-700/50 h-[84px] group-hover:border-violet-200 dark:group-hover:border-violet-700 transition-colors">
                                                <span className="text-lg font-bold text-slate-400 dark:text-slate-500 group-hover:text-violet-400 transition-colors">Nhập số tiền VNĐ</span>
                                            </div>
                                        )}
                                        ...
                                        <div className="space-y-3 mb-6 mt-auto">
                                            <div className="flex items-center gap-2.5 text-sm text-slate-600 dark:text-slate-300">
                                                ...
                                                <span className="font-medium">1 VNĐ = 1 Credit</span>
                                            </div>
                                            <div className="flex items-center gap-2.5 text-sm text-slate-600 dark:text-slate-300">
                                                <div className="w-5 h-5 rounded-full bg-emerald-100 dark:bg-emerald-500/20 flex items-center justify-center flex-shrink-0">
                                                    <Check className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
                                                </div>
                                                <span className="font-medium">Nạp nhanh 24/7 tự động</span>
                                            </div>
                                        </div>
                                        ...
                                        >
                                            <CreditCard className="w-4 h-4" />
                                            {selectedPackage?.code === 'CUSTOM' ? 'Đang chọn' : 'Nhập tuỳ chọn'}
                                        </button>
                                    </div>
                                ...
                                <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-slate-700 p-20 text-center">
                                    ...
                                    <h3 className="text-xl font-black text-slate-900 dark:text-white">Chưa có gói nào khả dụng</h3>
                                    <p className="text-slate-500 dark:text-slate-400 mt-2">Hệ thống đang cập nhật. Vui lòng quay lại sau nhé.</p>
                                </div>
                            )}
                        </div>
                    </div>
                            ...
                            {selectedPackage ? (
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center py-4 border-b border-dashed border-slate-200 dark:border-slate-700">
                                        <span className="text-slate-500 dark:text-slate-400 font-medium">Gói đã chọn</span>
                                    ...
                                    <div className="flex justify-between items-center py-4 border-b border-dashed border-slate-200 dark:border-slate-700">
                                        <span className="text-slate-500 dark:text-slate-400 font-medium">Số credits nhận</span>
                                    ...
                                    <div className="flex justify-between items-center pt-6 pb-2">
                                        <span className="text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider text-sm">Cần thanh toán</span>
                                    ...
                                    <div className="pt-6 pb-2">
                                        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">Phương thức thanh toán</p>
                                ...
                                <div className="text-center py-12 px-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-dashed border-slate-200 dark:border-slate-700">
                                    ...
                                    <h3 className="text-base font-bold text-slate-900 dark:text-white mb-2">Chưa chọn gói</h3>
                                    <p className="text-sm text-slate-500 dark:text-slate-400">Vui lòng chọn một gói credits bên trái để xem hoá đơn</p>
                                </div>
                            )}
                        </div>
                    </div>
