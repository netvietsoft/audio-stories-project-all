 ...
 *
 * Chạy:
 *   npx playwright test --project=api e2e/api/security.spec.ts
 *   TEST_USER_TOKEN=eyJ... TEST_ADMIN_TOKEN=eyJ... npx playwright test --project=api e2e/api/security.spec.ts
 */
