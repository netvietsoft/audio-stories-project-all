  ...
  const fetchTracks = useCallback(
    async (targetPage: number, append: boolean) => {
      ...
      try {
        ...
        // /music is double-wrapped ({ data: { data: [...], meta } }); unwrap defensively.
        ...
        const nextPage = Math.max(1, meta.page || targetPage);
        const nextLastPage = Math.max(1, meta.lastPage || 1);
        const nextTotal = Math.max(0, meta.total || 0);
