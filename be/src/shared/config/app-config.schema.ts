...
const RawEnvSchema = z
  .looseObject({
    ...
    // ffmpeg/ffprobe binaries. Default to PATH lookup (Linux VPS); local Windows
    // dev points these at a portable build (e.g. D:\SetupC\Tools\ffmpeg\bin).
    FFMPEG_PATH: stringNonEmpty.default('ffmpeg'),
    FFPROBE_PATH: stringNonEmpty.default('ffprobe'),
