      ...
      <div className={`grid grid-cols-1 gap-3 ${showKeywordInput ? 'md:grid-cols-2 lg:grid-cols-6' : 'md:grid-cols-2 lg:grid-cols-5'}`}>
        ...
        {showKeywordInput && (
          <div className="lg:col-span-1">
            <input
              ...
              className="w-full bg-slate-50 dark:bg-slate-800 rounded-xl py-3 px-4 text-sm font-medium text-slate-900 dark:text-white placeholder:text-slate-400 focus:ring-2 focus:ring-pink-500/20 border-none"
            />
          </div>
        )}
        ...
        <div className="relative" ref={categoryRef}>
          <button
            ...
            className="w-full bg-slate-50 dark:bg-slate-800 text-left rounded-xl py-3 px-4 text-sm font-bold text-slate-700 dark:text-slate-300 focus:ring-2 focus:ring-pink-500/20 transition-all flex items-center justify-between hover:bg-slate-100 dark:hover:bg-slate-700"
          >
            ...
            <div className="absolute z-50 top-full left-0 w-full mt-2 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
              <div className="p-3 border-b border-slate-100 dark:border-slate-700">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-900 border-none rounded-lg py-2 pl-10 pr-3 text-sm font-medium focus:ring-2 focus:ring-pink-500/20"
              ...
              <div className="max-h-60 overflow-y-auto">
                <button
                  ...
                  className="w-full text-left px-4 py-2.5 text-sm font-bold text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 hover:text-pink-600 transition-colors flex items-center justify-between"
                >
                  {t("allCategories")}
