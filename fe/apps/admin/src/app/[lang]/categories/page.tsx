                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-slate-50">
                            {isLoading ? (
                                ...
                                categories.map((cat) => (
                                    <tr key={cat.id} onClick={() => handleEdit(cat)} className={`group cursor-pointer hover:bg-slate-50/50 transition-all duration-300 ${selectedIds.has(cat.id) ? 'bg-indigo-50/30' : ''}`}>
