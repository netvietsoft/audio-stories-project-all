...
>>>>>>> b8b8c7bf2a3c7ac7765ffa49d13e904aabb61782
      {displayStories.map((story) => {
        ...
        return (
          ...
          >
            <div className="relative w-[100px] sm:w-[108px] xl:w-[124px] shrink-0 overflow-hidden rounded-lg">
              <Image
            ...
            <div className="min-w-0 flex flex-1 flex-col">
              ...
              <p className="mt-1.5 sm:mt-2 line-clamp-2 sm:line-clamp-4 text-xs sm:text-sm text-slate-700 dark:text-slate-300">
                {description || t("updating")}
              </p>

              <div className="mt-auto flex flex-wrap items-center gap-x-2 sm:gap-x-3 gap-y-1 pt-2 text-xs sm:text-sm text-slate-500 dark:text-slate-400">
