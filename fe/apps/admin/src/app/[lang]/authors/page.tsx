    ...
    const handleSubmit = async (data: any) => {
        ...
        try {
            if (editingAuthor) {
                ...
                setAuthors([...authors, created as Author].sort((a, b) => a.name.localeCompare(b.name)));
            }
                        ...
                        <tbody className="divide-y divide-slate-50">
                            {isLoading ? (
                                ...
                                filteredAuthors.map((author) => (
                                    <tr key={author.id} onClick={() => handleEdit(author)} className="group cursor-pointer hover:bg-slate-50/50 transition-all duration-300">
