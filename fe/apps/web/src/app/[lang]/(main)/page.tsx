...
export default async function LandingChoicePage({ params }: LandingChoicePageProps) {
  ...
  const t = await getTranslations({ locale: lang, namespace: "LandingChoicePage" });
    ...
    <div className="relative overflow-hidden rounded-[30px] border border-slate-200 bg-gradient-to-br from-rose-50 via-white to-orange-50 p-6 shadow-sm sm:p-8 lg:p-10 dark:border-[#303133] dark:from-[#23171d] dark:via-[#18181b] dark:to-[#1e1a15]">
      ...
      <div className="relative z-10 space-y-8">
        <div className="max-w-3xl space-y-3">
          ...
          <h1 className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl dark:text-white">{t("title")}</h1>
          <p className="max-w-2xl text-sm font-medium text-slate-600 sm:text-base dark:text-zinc-300">{t("subtitle")}</p>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          >
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div>
                <h2 className="text-2xl font-black text-slate-900 dark:text-white">{t("storyTitle")}</h2>
                <p className="mt-2 text-sm text-slate-600 dark:text-zinc-300">{t("storyDesc")}</p>
              </div>
          ...
          >
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div>
                <h2 className="text-2xl font-black text-slate-900 dark:text-white">{t("musicTitle")}</h2>
                <p className="mt-2 text-sm text-slate-600 dark:text-zinc-300">{t("musicDesc")}</p>
              </div>
