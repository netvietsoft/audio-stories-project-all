...
- **Bình luận theo đoạn**: đoạn có comment hiện bong bóp 💬 + số (bấm xem); **chạm giữ** đoạn để viết comment đầu tiên. Neo theo NỘI DUNG đoạn (thuật toán anchor đồng nhất với web) nên comment viết từ web hiện đúng đoạn trên app dù 2 bên tách đoạn khác nhau; fallback theo index.
